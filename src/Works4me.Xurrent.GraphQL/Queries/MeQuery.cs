...
namespace Works4me.Xurrent.GraphQL
{
    ...
    /// </summary>
    public class MeQuery : Query<Person, MeQuery, DefaultView, PersonField, DefaultFilterField, DefaultOrderField>
    {
        /// <summary>
        /// Initialize a new <see cref="MeQuery"/> instance.
        /// </summary>
        public MeQuery() : base("me", false)
        {
        }
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "Account" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "Addresses" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "Cart" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "ConfigurationItems" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "Contacts" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "CustomFields" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "CustomFieldsAttachments" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "InformationAttachments" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "Manager" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "Organization" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "OutOfOfficePeriods" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "Permissions" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "Site" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "SkillPools" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "Teams" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "UiExtension" sub-query.</returns>
        ...
        /// <returns>The same <see cref="MeQuery"/>, updated to include the "WorkHours" sub-query.</returns>
        ...
        /// </param>
        public MeQuery CustomFilter(string name, FilterOperator op, params string?[] values)
        {
            return AddCustomFilter(name, op, values);
        }

        /// <summary>
        /// Adds a free-form search filter to this <see cref="MeQuery"/>.
        /// </summary>
        /// <param name="value">The filter value.</param>
        /// <returns>The same <see cref="MeQuery">MeQuery</see>, updated to include the "QueryFilter" sub-query.</returns>
        public MeQuery Search(string value)
        {
