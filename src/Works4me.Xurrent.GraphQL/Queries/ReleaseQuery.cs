...
{
    /// <summary>
    /// The <see cref="Release"/> query class.
    /// </summary>
    public class ReleaseQuery : Query<Release, ReleaseQuery, ReleaseView, ReleaseField, ReleaseFilterField, ReleaseOrderField>
    {
        /// <summary>
        /// Initialize a new <see cref="ReleaseQuery"/> instance.
        /// </summary>
        public ReleaseQuery() : base("releases", true)
        {
        }
        ...
        /// <returns>The same <see cref="ReleaseQuery"/>, updated to include the "Account" sub-query.</returns>
        ...
        /// <returns>The same <see cref="ReleaseQuery"/>, updated to include the "CustomFields" sub-query.</returns>
        ...
        /// <returns>The same <see cref="ReleaseQuery"/>, updated to include the "CustomFieldsAttachments" sub-query.</returns>
        ...
        /// <returns>The same <see cref="ReleaseQuery"/>, updated to include the "Manager" sub-query.</returns>
        ...
        /// <returns>The same <see cref="ReleaseQuery"/>, updated to include the "Notes" sub-query.</returns>
        ...
        /// <returns>The same <see cref="ReleaseQuery"/>, updated to include the "UiExtension" sub-query.</returns>
        ...
        /// <returns>The same <see cref="ReleaseQuery"/>, updated to include the "Workflows" sub-query.</returns>
        ...
        /// <summary>
        /// <br>Filter the <see cref="Release">Release</see> by their custom fields that have been marked as "Filterable" in their UI Extension.</br>
        ...
        /// </param>
        public ReleaseQuery CustomFilter(string name, FilterOperator op, params string?[] values)
        {
            return AddCustomFilter(name, op, values);
        }

        /// <summary>
        /// Adds a free-form search filter to this <see cref="ReleaseQuery"/>.
        /// </summary>
        /// <param name="value">The filter value.</param>
        /// <returns>The same <see cref="ReleaseQuery">ReleaseQuery</see>, updated to include the "QueryFilter" sub-query.</returns>
        public ReleaseQuery Search(string value)
        {
