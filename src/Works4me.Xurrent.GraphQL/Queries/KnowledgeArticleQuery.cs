...
namespace Works4me.Xurrent.GraphQL
{
    ...
    public class KnowledgeArticleQuery : Query<KnowledgeArticle, KnowledgeArticleQuery, KnowledgeArticleView, KnowledgeArticleField, KnowledgeArticleFilterField, KnowledgeArticleOrderField>
    {
        ...
        /// <returns>The same <see cref="KnowledgeArticleQuery"/>, updated to include the "GoldenSetItems" sub-query.</returns>
        public KnowledgeArticleQuery SelectGoldenSetItems(GoldenSetItemQuery query)
        {
            if (query is null)
                throw new ArgumentNullException(nameof(query));
