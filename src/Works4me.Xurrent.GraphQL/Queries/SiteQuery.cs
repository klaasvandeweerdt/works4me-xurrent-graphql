...
{
    /// <summary>
    /// The <see cref="Site"/> query class.
    /// </summary>
    public class SiteQuery : Query<Site, SiteQuery, SiteView, SiteField, SiteFilterField, SiteOrderField>
    {
        /// <summary>
        /// Initialize a new <see cref="SiteQuery"/> instance.
        /// </summary>
        public SiteQuery() : base("sites", true)
        {
        }
        ...
        /// <returns>The same <see cref="SiteQuery"/>, updated to include the "Account" sub-query.</returns>
        ...
        /// <returns>The same <see cref="SiteQuery"/>, updated to include the "Addresses" sub-query.</returns>
        ...
        /// <returns>The same <see cref="SiteQuery"/>, updated to include the "CustomFields" sub-query.</returns>
        ...
        /// <returns>The same <see cref="SiteQuery"/>, updated to include the "CustomFieldsAttachments" sub-query.</returns>
        ...
        /// <returns>The same <see cref="SiteQuery"/>, updated to include the "People" sub-query.</returns>
        ...
        /// <returns>The same <see cref="SiteQuery"/>, updated to include the "RemarksAttachments" sub-query.</returns>
        ...
        /// <returns>The same <see cref="SiteQuery"/>, updated to include the "UiExtension" sub-query.</returns>
        ...
        /// <summary>
        /// <br>Filter the <see cref="Site">Site</see> by their custom fields that have been marked as "Filterable" in their UI Extension.</br>
        ...
        /// </param>
        public SiteQuery CustomFilter(string name, FilterOperator op, params string?[] values)
        {
            return AddCustomFilter(name, op, values);
        }

        /// <summary>
        /// Adds a free-form search filter to this <see cref="SiteQuery"/>.
        /// </summary>
        /// <param name="value">The filter value.</param>
        /// <returns>The same <see cref="SiteQuery">SiteQuery</see>, updated to include the "QueryFilter" sub-query.</returns>
        public SiteQuery Search(string value)
        {
