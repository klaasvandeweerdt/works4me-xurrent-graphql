...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/recurrence/">Recurrence</see> in Xurrent.
    /// </summary>
    [XurrentEntity("Recurrence")]
    public sealed class Recurrence : IDataItem
    {
        /// <summary>
        ...
        /// </summary>
        [XurrentField("endDate", IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [XurrentField("ical", IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [XurrentField("lastOccurrenceAt", IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [XurrentField("lastOccurrenceErrors", IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [XurrentField("nextOccurrenceAt", IsDefaultQueryProperty = true)]
        public DateTime? NextOccurrenceAt { get; internal set; }

        /// <summary>
        /// The date at which to start the Recurrence.
        /// </summary>
        [XurrentField("startDate", IsDefaultQueryProperty = true)]
#if NET6_0_OR_GREATER
