...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/rfctyperate/">RfcTypeRate</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("RfcTypeRate")]
    public sealed class RfcTypeRate : IDataItem, INode
    {
        /// <summary>
        ...
        /// <summary>
        /// The date and time of the last update of the RFC type rate. If the RFC type rate has no updates it contains the <c>createdAt</c> value.
        /// </summary>
