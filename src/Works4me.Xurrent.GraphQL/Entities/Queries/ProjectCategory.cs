...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/projectcategory/">ProjectCategory</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("ProjectCategory")]
    public sealed class ProjectCategory : IDataItem, INode, IRecord
    {
        /// <summary>
        ...
        {
            if (data is ProjectCategory projectCategory)
            {
                InformationAttachmentsCollection?.Data?.AddRange(projectCategory.InformationAttachments);
            }
        }
