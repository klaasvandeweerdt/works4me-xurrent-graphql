...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/trash/">Trash</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("Trash")]
    public sealed class Trash : IDataItem, INode
    {
        /// <summary>
