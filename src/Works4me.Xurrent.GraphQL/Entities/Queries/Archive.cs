...
{
    /// <summary>
    /// Represent an <see href="https://developer.xurrent.com/graphql/object/archive/">Archive</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("Archive")]
    public sealed class Archive : IDataItem, INode
    {
        /// <summary>
