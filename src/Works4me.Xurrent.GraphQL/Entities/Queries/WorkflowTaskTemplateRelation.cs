...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/workflowtasktemplaterelation/">WorkflowTaskTemplateRelation</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("WorkflowTaskTemplateRelation")]
    public sealed class WorkflowTaskTemplateRelation : IDataItem, IHasAutomationRules, INode
    {
        ...
        /// </summary>
        [XurrentField("failureTaskTemplate")]
        public WorkflowTaskTemplate? FailureTaskTemplate { get; internal set; }
        ...
        {
            if (data is WorkflowTaskTemplateRelation workflowTaskTemplateRelation)
            {
                AutomationRulesCollection?.Data?.AddRange(workflowTaskTemplateRelation.AutomationRules);
            }
        }
