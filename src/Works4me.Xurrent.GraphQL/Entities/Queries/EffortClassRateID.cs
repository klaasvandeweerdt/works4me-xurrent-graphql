...
{
    /// <summary>
    /// Represent an <see href="https://developer.xurrent.com/graphql/object/effortclassrateid/">EffortClassRateID</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("EffortClassRateID")]
    public sealed class EffortClassRateID : IDataItem, INode
    {
        /// <summary>
