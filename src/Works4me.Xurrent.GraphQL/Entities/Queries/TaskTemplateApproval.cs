...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/tasktemplateapproval/">TaskTemplateApproval</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("TaskTemplateApproval")]
    public sealed class TaskTemplateApproval : IDataItem, INode
    {
        /// <summary>
