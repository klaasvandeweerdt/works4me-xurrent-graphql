...
{
    /// <summary>
    /// Represent an <see href="https://developer.xurrent.com/graphql/object/emailtemplate/">EmailTemplate</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("EmailTemplate")]
    public sealed class EmailTemplate : IDataItem, IHasTranslations, INode, IRecord
    {
        /// <summary>
        ...
        {
            if (data is EmailTemplate emailTemplate)
            {
                TranslationsCollection?.Data?.AddRange(emailTemplate.Translations);
            }
        }
