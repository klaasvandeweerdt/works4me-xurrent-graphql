...
{
    /// <summary>
    /// Represent an <see href="https://developer.xurrent.com/graphql/object/appofferingautomationrule/">AppOfferingAutomationRule</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("AppOfferingAutomationRule")]
    public sealed class AppOfferingAutomationRule : IDataItem, INode, IRecord
    {
        /// <summary>
