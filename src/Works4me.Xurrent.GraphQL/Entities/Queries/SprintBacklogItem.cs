...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/sprintbacklogitem/">SprintBacklogItem</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("SprintBacklogItem")]
    public sealed class SprintBacklogItem : IDataItem, INode, IRecord
    {
        /// <summary>
