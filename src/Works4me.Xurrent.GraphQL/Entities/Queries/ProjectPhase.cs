...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/projectphase/">ProjectPhase</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("ProjectPhase")]
    public sealed class ProjectPhase : IDataItem, INode
    {
        /// <summary>
