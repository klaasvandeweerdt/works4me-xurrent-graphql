...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/projecttemplatephase/">ProjectTemplatePhase</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("ProjectTemplatePhase")]
    public sealed class ProjectTemplatePhase : IDataItem, INode
    {
        /// <summary>
