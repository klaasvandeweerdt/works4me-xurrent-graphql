...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/tag/">Tag</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("Tag")]
    public sealed class Tag : IDataItem, INode, IRecord
    {
        /// <summary>
