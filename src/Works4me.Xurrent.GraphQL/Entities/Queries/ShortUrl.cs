...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/shorturl/">ShortUrl</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("ShortUrl")]
    public sealed class ShortUrl : IDataItem, INode, IRecord
    {
        /// <summary>
        /// Unique token that someone who uses the short URL for a dashboard is asked to enter.
        /// </summary>
        [XurrentField("accessToken")]
        ...
        public Uri? ShortenedUrl { get; internal set; }
