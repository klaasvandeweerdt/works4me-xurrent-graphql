...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/webhookpolicy/">WebhookPolicy</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("WebhookPolicy")]
    public sealed class WebhookPolicy : IDataItem, INode, IRecord
    {
        /// <summary>
