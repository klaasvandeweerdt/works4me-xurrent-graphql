...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/customcollectionelement/">CustomCollectionElement</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("CustomCollectionElement")]
    public sealed class CustomCollectionElement : IDataItem, IHasTranslations, INode, IRecord
    {
        /// <summary>
        ...
        {
            if (data is CustomCollectionElement customCollectionElement)
            {
                CustomFieldsAttachmentsCollection?.Data?.AddRange(customCollectionElement.CustomFieldsAttachments);
                InformationAttachmentsCollection?.Data?.AddRange(customCollectionElement.InformationAttachments);
                TranslationsCollection?.Data?.AddRange(customCollectionElement.Translations);
            }
        }
