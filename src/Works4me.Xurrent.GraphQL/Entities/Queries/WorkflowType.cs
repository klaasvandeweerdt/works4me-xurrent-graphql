...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/workflowtype/">WorkflowType</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    [XurrentEntity("WorkflowType")]
    public sealed class WorkflowType : IDataItem, IHasTranslations, INode, IRecord
    {
        /// <summary>
        ...
        {
            if (data is WorkflowType workflowType)
            {
                InformationAttachmentsCollection?.Data?.AddRange(workflowType.InformationAttachments);
                TranslationsCollection?.Data?.AddRange(workflowType.Translations);
            }
        }
