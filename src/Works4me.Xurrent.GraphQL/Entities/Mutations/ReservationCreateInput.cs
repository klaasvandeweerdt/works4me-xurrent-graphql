...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/reservationcreateinput/">ReservationCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class ReservationCreateInput : PropertyChangeSet
    {
        ...
        {
            _name = string.Empty;
            _reservationOfferingId = string.Empty;
            _startAt = default;
            _configurationItemId = string.Empty;
        ...
        /// </summary>
        public ReservationCreateInput(string name, string reservationOfferingId, DateTime startAt, string configurationItemId, string personId)
        {
            _name = Set("name", name);
            _reservationOfferingId = Set("reservationOfferingId", reservationOfferingId);
            _startAt = Set("startAt", startAt);
            _configurationItemId = Set("configurationItemId", configurationItemId);
