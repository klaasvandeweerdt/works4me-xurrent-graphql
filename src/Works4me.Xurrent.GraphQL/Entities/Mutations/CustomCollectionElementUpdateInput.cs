...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/customcollectionelementupdateinput/">CustomCollectionElementUpdateInput</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    public sealed class CustomCollectionElementUpdateInput : PropertyChangeSet
    {
