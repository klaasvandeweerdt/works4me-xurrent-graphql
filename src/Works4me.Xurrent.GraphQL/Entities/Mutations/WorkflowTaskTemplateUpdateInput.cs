...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/tasktemplateupdateinput/">WorkflowTaskTemplateUpdateInput</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    public sealed class WorkflowTaskTemplateUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTaskTemplateUpdateInput"/> class without providing the required values.
        /// </summary>
        public WorkflowTaskTemplateUpdateInput()
        {
            _id = string.Empty;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTaskTemplateUpdateInput"/> class.
        /// </summary>
        public WorkflowTaskTemplateUpdateInput(string id)
        {
            _id = Set("id", id);
        }
    }
