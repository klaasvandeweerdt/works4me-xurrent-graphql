...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/customcollectionupdateinput/">CustomCollectionUpdateInput</see> in Xurrent.
    /// </summary>
    public sealed class CustomCollectionUpdateInput : PropertyChangeSet
    {
        ...
        private string _id;
        private Collection<string>? _collectionElementsToDelete;
        ...
        /// </summary>
        [XurrentField("collectionElementsToDelete")]
        public Collection<string>? CollectionElementsToDelete
        {
            get => _collectionElementsToDelete;
            set => _collectionElementsToDelete = Set("collectionElementsToDelete", value);
        }
