...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/tasktemplatecreateinput/">WorkflowTaskTemplateCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class WorkflowTaskTemplateCreateInput : PropertyChangeSet
    {
        ...
        private long? _plannedEffortWorkflowManager;
        ...
        private Collection<TaskTemplateApprovalInput>? _newApprovals;
        ...
        public bool? AssignToWorkflowManager
        {
            ...
            set => _assignToWorkflowManager = Set("assignToWorkflowManager", value);
        }
        ...
        {
            get => _plannedEffortWorkflowManager;
            set => _plannedEffortWorkflowManager = Set("plannedEffortWorkflowManager", value);
        }
        ...
        public Collection<TaskTemplateApprovalInput>? NewApprovals
        {
            get => _newApprovals;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTaskTemplateCreateInput"/> class without providing the required values.
        /// </summary>
        public WorkflowTaskTemplateCreateInput()
        {
            _category = default;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTaskTemplateCreateInput"/> class.
        /// </summary>
        public WorkflowTaskTemplateCreateInput(TaskCategory category, long plannedDuration, string subject)
        {
