...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/riskseverityupdateinput/">RiskSeverityUpdateInput</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    public sealed class RiskSeverityUpdateInput : PropertyChangeSet
    {
