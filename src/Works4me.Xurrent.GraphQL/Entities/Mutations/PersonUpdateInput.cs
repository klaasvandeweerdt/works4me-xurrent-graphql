...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/personupdateinput/">PersonUpdateInput</see> in Xurrent.
    /// </summary>
    public sealed class PersonUpdateInput : PropertyChangeSet
    {
        ...
        private Collection<string>? _contactsToDelete;
        private Collection<string>? _accountPermissionsToDelete;
        ...
        /// </summary>
        [XurrentField("contactsToDelete")]
        public Collection<string>? ContactsToDelete
        {
            get => _contactsToDelete;
            set => _contactsToDelete = Set("contactsToDelete", value);
        }

        /// <summary>
        /// Identifiers of accounts this person's permissions will be deleted for. Permissions for other accounts will not be altered.
        /// </summary>
        [XurrentField("accountPermissionsToDelete")]
        public Collection<string>? AccountPermissionsToDelete
        {
            get => _accountPermissionsToDelete;
            set => _accountPermissionsToDelete = Set("accountPermissionsToDelete", value);
        }
