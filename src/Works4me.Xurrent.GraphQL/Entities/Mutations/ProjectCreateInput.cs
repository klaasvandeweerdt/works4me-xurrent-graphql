...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/projectcreateinput/">ProjectCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class ProjectCreateInput : PropertyChangeSet
    {
        ...
        public ProjectCreateInput(string customerId, ProjectJustification justification, string managerId, string serviceId, string subject)
        {
            ...
            _justification = Set("justification", justification);
