...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/knowledgearticlecreateinput/">KnowledgeArticleCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class KnowledgeArticleCreateInput : PropertyChangeSet
    {
        ...
        {
            _instructions = Set("instructions", instructions);
