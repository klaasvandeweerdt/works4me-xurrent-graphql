...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/riskcreateinput/">RiskCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class RiskCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        public RiskCreateInput(string subject, string severity)
        {
            _subject = Set("subject", subject);
            _severity = Set("severity", severity);
        }
    }
}
