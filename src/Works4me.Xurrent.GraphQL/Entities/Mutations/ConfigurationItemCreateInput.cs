...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/configurationitemcreateinput/">ConfigurationItemCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class ConfigurationItemCreateInput : PropertyChangeSet
    {
        ...
        {
            _productId = Set("productId", productId);
