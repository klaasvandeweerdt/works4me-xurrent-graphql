...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/timesheetsettingupdateinput/">TimesheetSettingUpdateInput</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    public sealed class TimesheetSettingUpdateInput : PropertyChangeSet
    {
