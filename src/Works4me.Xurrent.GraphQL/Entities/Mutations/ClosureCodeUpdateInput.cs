...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/closurecodeupdateinput/">ClosureCodeUpdateInput</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    public sealed class ClosureCodeUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClosureCodeUpdateInput"/> class without providing the required values.
        /// </summary>
        public ClosureCodeUpdateInput()
        {
            _id = string.Empty;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ClosureCodeUpdateInput"/> class.
        /// </summary>
        public ClosureCodeUpdateInput(string id)
        {
            _id = Set("id", id);
        }
    }
