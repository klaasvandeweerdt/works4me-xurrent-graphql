...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/sprintcreateinput/">SprintCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class SprintCreateInput : PropertyChangeSet
    {
        ...
        {
            _scrumWorkspaceId = string.Empty;
        }
        ...
        {
            _scrumWorkspaceId = Set("scrumWorkspaceId", scrumWorkspaceId);
        }
    }
}
