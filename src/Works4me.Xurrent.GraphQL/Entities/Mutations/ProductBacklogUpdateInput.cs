...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/productbacklogupdateinput/">ProductBacklogUpdateInput</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    public sealed class ProductBacklogUpdateInput : PropertyChangeSet
    {
