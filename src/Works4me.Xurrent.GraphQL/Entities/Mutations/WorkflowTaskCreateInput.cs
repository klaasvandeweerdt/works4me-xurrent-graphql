...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/taskcreateinput/">WorkflowTaskCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class WorkflowTaskCreateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTaskCreateInput"/> class without providing the required values.
        /// </summary>
        public WorkflowTaskCreateInput()
        {
            _workflowId = string.Empty;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTaskCreateInput"/> class.
        /// </summary>
        public WorkflowTaskCreateInput(string workflowId)
        {
            _workflowId = Set("workflowId", workflowId);
        }
    }
}
