...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/teamupdateinput/">TeamUpdateInput</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    public sealed class TeamUpdateInput : PropertyChangeSet
    {
