...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/customcollectionelementinput/">CustomCollectionElementInput</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    public sealed class CustomCollectionElementInput : PropertyChangeSet
    {
        private string? _id;
