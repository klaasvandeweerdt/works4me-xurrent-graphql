...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/projecttaskcreateinput/">ProjectTaskCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class ProjectTaskCreateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Tags to be added to the project task.
        /// </summary>
        ...
        /// </summary>
        public ProjectTaskCreateInput(string projectId, string phaseId, ProjectTaskCategory category, long plannedDuration, string subject)
        {
            _projectId = Set("projectId", projectId);
            _phaseId = Set("phaseId", phaseId);
