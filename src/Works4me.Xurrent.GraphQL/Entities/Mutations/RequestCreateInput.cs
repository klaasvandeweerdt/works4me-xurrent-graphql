...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/requestcreateinput/">RequestCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class RequestCreateInput : PropertyChangeSet
    {
        ...
        {
            get => _supportDomain;
            set => _supportDomain = Set("supportDomain", value);
        }
    }
}
