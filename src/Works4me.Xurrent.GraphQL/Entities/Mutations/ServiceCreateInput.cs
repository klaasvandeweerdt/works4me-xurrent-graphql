...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/servicecreateinput/">ServiceCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class ServiceCreateInput : PropertyChangeSet
    {
