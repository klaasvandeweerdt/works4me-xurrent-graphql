...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/broadcastcreateinput/">BroadcastCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class BroadcastCreateInput : PropertyChangeSet
    {
        ...
        {
            _messageType = Set("messageType", messageType);
        }
    }
}
