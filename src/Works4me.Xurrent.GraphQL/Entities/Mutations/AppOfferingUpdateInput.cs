...
{
    /// <summary>
    /// Represent an <see href="https://developer.xurrent.com/graphql/object/appofferingupdateinput/">AppOfferingUpdateInput</see> in Xurrent.
    /// </summary>
    public sealed class AppOfferingUpdateInput : PropertyChangeSet
    {
        ...
        private string _id;
        private Collection<string>? _scopesToDelete;
        ...
        /// </summary>
        [XurrentField("scopesToDelete")]
        public Collection<string>? ScopesToDelete
        {
            get => _scopesToDelete;
            set => _scopesToDelete = Set("scopesToDelete", value);
        }
