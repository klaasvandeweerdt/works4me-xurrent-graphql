...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/workflowupdateinput/">WorkflowUpdateInput</see> in Xurrent.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    public sealed class WorkflowUpdateInput : PropertyChangeSet
    {
