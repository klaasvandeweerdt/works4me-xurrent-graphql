...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/closurecodecreateinput/">ClosureCodeCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class ClosureCodeCreateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClosureCodeCreateInput"/> class without providing the required values.
        /// </summary>
        public ClosureCodeCreateInput()
        {
            _name = string.Empty;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ClosureCodeCreateInput"/> class.
        /// </summary>
        public ClosureCodeCreateInput(string name)
        {
            _name = Set("name", name);
        }
    }
