...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/timeentrycreateinput/">TimeEntryCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class TimeEntryCreateInput : PropertyChangeSet
    {
        ...
        {
            _timeSpent = Set("timeSpent", timeSpent);
        }
    }
}
