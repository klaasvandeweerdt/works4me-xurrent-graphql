...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/contractcreateinput/">ContractCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class ContractCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        public ContractCreateInput(string name, string customerId)
        {
            _name = Set("name", name);
