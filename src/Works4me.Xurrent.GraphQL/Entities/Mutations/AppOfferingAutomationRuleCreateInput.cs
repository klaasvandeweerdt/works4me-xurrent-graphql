...
{
    /// <summary>
    /// Represent an <see href="https://developer.xurrent.com/graphql/object/appofferingautomationrulecreateinput/">AppOfferingAutomationRuleCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class AppOfferingAutomationRuleCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        public AppOfferingAutomationRuleCreateInput(string appOfferingId, string name, string trigger, string condition)
        {
