...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/servicelevelagreementcreateinput/">ServiceLevelAgreementCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class ServiceLevelAgreementCreateInput : PropertyChangeSet
    {
        ...
        public ServiceLevelAgreementCreateInput()
        {
            ...
            _name = string.Empty;
            _serviceOfferingId = string.Empty;
        }
        ...
        {
            _customerId = Set("customerId", customerId);
            _name = Set("name", name);
            _serviceOfferingId = Set("serviceOfferingId", serviceOfferingId);
        }
    }
}
