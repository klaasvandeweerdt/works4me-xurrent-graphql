...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/timeallocationcreateinput/">TimeAllocationCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class TimeAllocationCreateInput : PropertyChangeSet
    {
        ...
        {
            _name = string.Empty;
            _customerCategory = default;
            _descriptionCategory = default;
            _serviceCategory = default;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="TimeAllocationCreateInput"/> class.
        /// </summary>
        public TimeAllocationCreateInput(string name, TimeAllocationCustomerCategory customerCategory, TimeAllocationDescriptionCategory descriptionCategory, TimeAllocationServiceCategory serviceCategory)
        {
            _name = Set("name", name);
            _customerCategory = Set("customerCategory", customerCategory);
            _descriptionCategory = Set("descriptionCategory", descriptionCategory);
            _serviceCategory = Set("serviceCategory", serviceCategory);
        }
    }
}
