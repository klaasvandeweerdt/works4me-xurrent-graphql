...
{
    /// <summary>
    /// Represent a <see href="https://developer.xurrent.com/graphql/object/firstlinesupportagreementcreateinput/">FirstLineSupportAgreementCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class FirstLineSupportAgreementCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        public FirstLineSupportAgreementCreateInput(string name, string customerId, string providerId)
        {
            _name = Set("name", name);
            _customerId = Set("customerId", customerId);
            _providerId = Set("providerId", providerId);
        }
    }
}
