...
{
    /// <summary>
    /// Represent an <see href="https://developer.xurrent.com/graphql/object/appinstancecreateinput/">AppInstanceCreateInput</see> in Xurrent.
    /// </summary>
    public sealed class AppInstanceCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [XurrentField("customerAccountId")]
        public string CustomerAccountId
        {
            get => _customerAccountId;
            set => _customerAccountId = Set("customerAccountId", value);
        }

        /// <summary>
        /// Identifier of the app offering to create an instance of.
        /// </summary>
        [XurrentField("appOfferingId")]
        public string AppOfferingId
        {
            get => _appOfferingId;
            set => _appOfferingId = Set("appOfferingId", value);
        }
        ...
        {
            _customerAccountId = string.Empty;
            _appOfferingId = string.Empty;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="AppInstanceCreateInput"/> class.
        /// </summary>
        public AppInstanceCreateInput(string customerAccountId, string appOfferingId)
        {
            _customerAccountId = Set("customerAccountId", customerAccountId);
            _appOfferingId = Set("appOfferingId", appOfferingId);
        }
    }
}
