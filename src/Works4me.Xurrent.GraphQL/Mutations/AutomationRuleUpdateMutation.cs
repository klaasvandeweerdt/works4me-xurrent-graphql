namespace Works4me.Xurrent.GraphQL.Mutations
{
    ...
    internal sealed class AutomationRuleUpdateMutation : Mutation<AutomationRuleUpdateInput>
    {
        ...
        internal AutomationRuleUpdateMutation(AutomationRuleUpdateInput data, AutomationRuleQuery? query)
            : base("automationRuleUpdate", "AutomationRuleUpdateInput!", data, query is null ? new AutomationRuleUpdatePayloadQuery() : new AutomationRuleUpdatePayloadQuery().Select(UpdateQuery(query, "automationRule")))
        {
        }
    }
}
