namespace Works4me.Xurrent.GraphQL.Mutations
{
    ...
    internal sealed class WorkflowCreateMutation : Mutation<WorkflowCreateInput>
    {
        ...
        internal WorkflowCreateMutation(WorkflowCreateInput data, WorkflowQuery? query)
            : base("workflowCreate", "WorkflowCreateInput!", data, query is null ? new WorkflowCreatePayloadQuery() : new WorkflowCreatePayloadQuery().Select(UpdateQuery(query, "workflow")))
        {
        }
    }
}
