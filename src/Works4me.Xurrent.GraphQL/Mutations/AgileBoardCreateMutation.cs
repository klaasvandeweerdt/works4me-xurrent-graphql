namespace Works4me.Xurrent.GraphQL.Mutations
{
    ...
    internal sealed class AgileBoardCreateMutation : Mutation<AgileBoardCreateInput>
    {
        ...
        internal AgileBoardCreateMutation(AgileBoardCreateInput data, AgileBoardQuery? query)
            : base("agileBoardCreate", "AgileBoardCreateInput!", data, query is null ? new AgileBoardCreatePayloadQuery() : new AgileBoardCreatePayloadQuery().Select(UpdateQuery(query, "agileBoard")))
        {
        }
    }
}
