namespace Works4me.Xurrent.GraphQL.Mutations
{
    ...
    internal sealed class SlaNotificationSchemeUpdateMutation : Mutation<SlaNotificationSchemeUpdateInput>
    {
        ...
        internal SlaNotificationSchemeUpdateMutation(SlaNotificationSchemeUpdateInput data, SlaNotificationSchemeQuery? query)
            : base("slaNotificationSchemeUpdate", "SlaNotificationSchemeUpdateInput!", data, query is null ? new SlaNotificationSchemeUpdatePayloadQuery() : new SlaNotificationSchemeUpdatePayloadQuery().Select(UpdateQuery(query, "slaNotificationScheme")))
        {
        }
    }
}
