namespace Works4me.Xurrent.GraphQL.Mutations
{
    ...
    internal sealed class ShopArticleCategoryUpdateMutation : Mutation<ShopArticleCategoryUpdateInput>
    {
        ...
        internal ShopArticleCategoryUpdateMutation(ShopArticleCategoryUpdateInput data, ShopArticleCategoryQuery? query)
            : base("shopArticleCategoryUpdate", "ShopArticleCategoryUpdateInput!", data, query is null ? new ShopArticleCategoryUpdatePayloadQuery() : new ShopArticleCategoryUpdatePayloadQuery().Select(UpdateQuery(query, "shopArticleCategory")))
        {
        }
    }
}
