namespace Works4me.Xurrent.GraphQL.Mutations
{
    ...
    internal sealed class OutOfOfficePeriodUpdateMutation : Mutation<OutOfOfficePeriodUpdateInput>
    {
        ...
        internal OutOfOfficePeriodUpdateMutation(OutOfOfficePeriodUpdateInput data, OutOfOfficePeriodQuery? query)
            : base("outOfOfficePeriodUpdate", "OutOfOfficePeriodUpdateInput!", data, query is null ? new OutOfOfficePeriodUpdatePayloadQuery() : new OutOfOfficePeriodUpdatePayloadQuery().Select(UpdateQuery(query, "outOfOfficePeriod")))
        {
        }
    }
}
