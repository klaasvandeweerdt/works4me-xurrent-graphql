namespace Works4me.Xurrent.GraphQL.Mutations
{
    ...
    internal sealed class ScrumWorkspaceCreateMutation : Mutation<ScrumWorkspaceCreateInput>
    {
        ...
        internal ScrumWorkspaceCreateMutation(ScrumWorkspaceCreateInput data, ScrumWorkspaceQuery? query)
            : base("scrumWorkspaceCreate", "ScrumWorkspaceCreateInput!", data, query is null ? new ScrumWorkspaceCreatePayloadQuery() : new ScrumWorkspaceCreatePayloadQuery().Select(UpdateQuery(query, "scrumWorkspace")))
        {
        }
    }
}
